...
const TicketDitails = () => {
    ...
    return (
        ...
        >
          <Typography fontWeight={600} textAlign='center'>پشتیبانی</Typography>
        </Box>
        {loading && (
        ...
        <Box p={{ xs: 2, md: 5 }} textAlign='right'>
          <Formik
            initialValues={{
              title: info.title || "",
                  ...
                  <Grid container spacing={3}>
                    ...
                    {list.map((i, index) => (
                      <Grid item xs={12} key={index}>
                        ...
                        >
                          <label style={{ fontWeight: "300" }}>
                            {i.user_id === userId ? "پیام ادمین" : "پیام کاربر"}
                          </label>
                          <Field
                            value={i.content}
                            as="textarea"
